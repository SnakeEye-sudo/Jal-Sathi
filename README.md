...
Hydration companion with goals, logging, and reminder rhythm in a calm mobile dashboard.

- Live website: https://snakeeye-sudo.github.io/Jal-Sathi/
- Family hub: https://snakeeye-sudo.github.io/Aapka-Sathi/
- GitHub repo: https://github.com/SnakeEye-sudo/Jal-Sathi
- Tags: sathi-family, hydration, health-app, tracker, pwa, hindi-app
